...
client.on('guildCreate', guild => {
   const botownerid = "806810037459746846";
   const botownerid2 = "806810037459746846";
...
require("http").createServer((_, res) => res.end("Copyright 2020-2021 MaxGamerOffical\n\nLinks:\n https://dsc.gg/development.world\n\nDONT REMOVE CREDITS")).listen(8080)